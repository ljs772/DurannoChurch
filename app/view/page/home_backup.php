			...
			<div class=" col-md-12 col-lg-12 m-padding0 video-background">
				<section  id="video">   
					<div  class="col-md-3 col-lg-3 home_video m-padding0">					 
		           	...
		           	<div class="col-md-3 col-lg-3 home_video_text" id="home_video_text">
							<h1>주일설교</h1>
		...
		<?php  } ?>            
			...
			<div  class="col-md-6 m-padding0">
		        ...
		        <div  class="photo-title"> 
							...
							<div class="col-md-12">
								<div class="col-md-12  text-left  " id="">
									<span class="col-md-7 m-box1-left m-padding5"><h4>주일예배</h4> </span>
									<span class="col-md-5 m-box1-right "><h4>주일  2pm</h4></span>
								</div>
								<div class="col-md-12  text-left  " id="">
									<span class="col-md-7 m-box1-left m-padding5"><h4>주일어린이예배</h4></span>
									<span
										class="col-md-5 m-box1-right "><h4>주일  12pm</h4></span>
								</div>
								<div class="col-md-12  text-left " id="">
									<span class="col-md-7 m-box1-left m-padding5"><h4>수요예배(성경공부)</h4></span>
									<span
										class="col-md-5 m-box1-right "><h4>수 8pm</h4></span>
								</div>
								<div class="col-md-12  text-left " id="">
									<span class="col-md-7 m-box1-left m-padding5"><h4>금요예배(기도)</h4></span>
									<span
										class="col-md-5 m-box1-right "><h4>금 8pm</h4></span>
								</div>
								<div class="col-md-12  text-left " id="">
									<span class="col-md-7 m-box1-left m-padding5"><h4>새벽기도</h4></span>
									<span
										class="col-md-5 m-box1-right "><h4>화~토 6am</h4></span>
								</div>
								<div class="col-md-12  text-left !m-box1" id="">
									<span class="col-md-7 m-box1-left m-padding5"><h4>매일저녁 기도회</h4></span>
									<span	class="col-md-5 m-box1-right "><h4>매일 8pm</h4></span>
								</div>
							</div>
						</div>        
				</section>
		...
		<div class="col-md-12 m_home_div"></div>
		 ...
		 <div class="col-md-12 ">
			...
			<section  id="small-ad"  class=" m-padding0">     
		      	      <div  class="home-location col-md-12 m-padding0">
			...
			<section  id="small-ad"  class=" m-padding0">     
	              		...
	              		<div  class="home-counsel col-md-12 m-padding0"> 
	              		 <div class ="col-md-2"><img src="images/icon/question.png" /> </div> 
	              		 <div class ="col-md-10 text-left"><h4><b>신앙 생활</b>을 하다가</h4>
	              		  <h4><b>성경</b>을 읽다가</h4>
	              		 <h5>궁금한 점이 있으시면 질문해 주세요.</h5> 
	              		  담임목사 : 이강화<br/>
	              		  <h4>647-980-5791</h4>
	              		  <h4>kanghwa73@gmail.com</h4></div> 	              			
...
$("#home_video_text").click(function(){
