...
<div class="col-md-12 col-lg-12" style="background: #c0c0c0; padding:5px;">
<div class="col-md-6 col-lg-6" style="background: #ffffff; ">

<section  id="video">   
					<div  class="col-md-6 col-lg-6 home_video m-padding0 ">					 
		           	...
		           	<div class="col-md-6 col-lg-6 home_video_text m-padding0" id="home_video_text_big">
							<h1>주일설교</h1>
		           	   ...
		           	   <div class="col-md-6 col-lg-6 home_video_tex m-padding0" id="home_video_text_small">
...
<div  class="col-md-3 col-lg-3 home-location-big  "> 
<section  id="small-ad">       
	        ...
	        <div  class="col-md-12 col-lg-12 home-location-small  ">      		
	              			<section  id="small-ad">  	
...
<div  class="col-md-3  home-counsel-big "> 	
...
<section  id="small-ad">     
	              					...
	              					<h1>신앙 상담</h1>              		 			
	              		 			...
	              		 			<div  class="col-md-3  home-counsel-small "> 	
	              		 			<section  id="small-ad"> 	
	              					<h1>신앙 상담</h1>  
	              					담임목사 : 이강화<br/>
...
<div class="col-md-6 col-lg-6" style=" background: #f528ff; padding:10px;">
safasfsf
</div>
</div>
...
<div  class="col-md-6 col-lg-6  home_evening  ">   

</div>

<div  class="col-md-6 col-lg-6  home_early  ">   
