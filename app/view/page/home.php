				...
				<section  id="video">   
					<div  class="col-md-3 col-lg-3 home_video m-padding0">					 
	              	...
	              	<div  class="col-md-6 col-lg-6  home_evening  m-padding0">       
	              		...
	              		<p>도심속 기도원 같은 곳,</p>
						<p>날마다 마음을 주님 앞에 털어놓고 울 수 있는 곳,</p>
						<p>매일 저녁 8시부터 성전은 항상 열려 있습니다</p>							
							</div> 
	              	</div> 
		...
		<div class="col-md-12 m_home_div"></div>
		 ...
		 <div class="col-md-12 ">
				...
				<div  class="col-md-6 col-lg-6  home_early  m-padding0">       
	              		...
	              		<img src="images/main/esl.png" />  
	              		<div class="home_esl_text">
	              		<h1 class="home_esl_text1">ESL</h1><br/>
	              			<h4 class="home_esl_text2">Basic 과정  토요일(9:00-11:30 오전)</h4>
							<h4 class="home_esl_text2"></h4>							
							<h4 class="home_esl_text3">$20/Month, 문의:647)980-5791 </h4>
							<h3 class="home_esl_text4">with Tim Stevens</h3>
							</div> 
	              	</div> 
	</div>
		<div class="col-md-12 m_home_div"></div>
		...
		<div class="col-md-6 m-padding0">
				<section  id="durannoNews" >
					<div  class="col-md-12 !home-box2">
						<div class="news-title ">두란노 소식<a href="subpage/durannoNews"><i class="material-icons">more</i></a></div>
	                    <div class="text-center">
	       
	<?php            
	        	// `id`, `title`, `planed_date`,`div`, `description`
	foreach($news as $new){ ?>
	           				<label class="col-xs-12 col-sm-9 col-md-9 col-lg-9  home-news  text-left"><b><?= $new['title']?></b></label>
	           				<label class="col-xs-12 col-sm-3 col-md-3 col-lg-3  home-news  text-left"> <?= $new['planed_date']?></label>
	<?php } ?>       
	             		</div>           
					</div>
				</section>
			...
			<!-- <div class="col-md-6 m-padding0">
				<section  id="memberNews">
					<div  class="col-md-12 home-box2">
						<div class="news-title"><span>교우 소식</span><a href="subpage/memberNews"><i class="material-icons m-padding0">more</i></a></div>
	                   	<div class="text-center">
				...
				<section  id="photo ">     
		        	<div  class="col-md-12  ">
		         		<div  class="photo-title"> 
		         			...
		         			<span  class="title_right"> <a href="subpage/gallery"><i class="material-icons">more</i></a></span>
		         		</div>
		<?php            
		...
		<div  class="col-md-3 m-padding0">
			...
			<div  class="col-md-6 m-padding0">
		        ...
		        <div  class="photo-title m-padding0"> 
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 m-padding0">
